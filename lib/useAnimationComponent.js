...
var useAnimationComponent = function (props) {
    /**  */
    var imageSrc = props.imageSrc, atlas = props.atlasConfig, animations = props.animationConfig, animationName = props.animationName;
    /**  */
    ...
    (0, react_1.useEffect)(function () {
        if (canvasRef.current && loaded) {
            ...
            var pw = parentSize.w > objectSize.w ? objectSize.w : parentSize.w;
            var ph = parentSize.h > objectSize.h ? objectSize.h : parentSize.h;
            ctx === null || ctx === void 0 ? void 0 : ctx.drawImage(image, objectPosition.x, objectPosition.y, objectSize.w, objectSize.h, 0, 0, pw, ph);
        }
